...
class InfoEndPointApiTest {
    ...
    void testContributeSuccess() throws Exception {
        String manifestContent = "Manifest-Version: 1.0\n" + "Implementation-Version: 1.2.3\n"
                + "Implementation-Title: animal-insurance\n\n";
        ...
        Assertions.assertEquals("animal-insurance", info.get("serviceName"), "Expected service name does not match.");
        Assertions.assertEquals("The animal-insurance micro-service for FINEOS.", info.get("description"),
